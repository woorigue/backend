...
@banner_router.post("")
async def add_banner(banner_img:UploadFile, db: Session = Depends(get_db)):
...
async def edit_banner(banner_id:int, banner_img:UploadFile, db: Session = Depends(get_db)):
