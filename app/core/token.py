...
SECRET_KEY = "NvbeIjVAT/MW8ihG5pWzb03pzI3PlSCRFJE8B0IzyUAlIzxXiJinD8ywbjQEfOilhkD+fARoW/SlWiU5LrFncw=="
ALGORITHM = "HS256"
...
def create_access_token(data: dict):
    ...
    to_encode.update({"exp": expire, "role": "authenticated", "aud": "authenticated"})
